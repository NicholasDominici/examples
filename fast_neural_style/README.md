...
* `--dataset`: path to training dataset, the path should point to a folder containing another folder with all the training images. I used COCO 2017 Training images dataset [118K/18GB] [(download)](http://mscoco.org/dataset/#download).
